...
| `case_gallery.json` | `file://demo/case_gallery.json` | 9655 | `f630b31cc2bfed82940ef9f9d59611d4637b15e583e74444d35ded61127c6906` | Machine-readable case gallery with complete packet payloads. | `python -m portfolio_fee_drag_simulator case-gallery --output demo` |
