...
| `case_gallery.json` | `file://demo/case_gallery.json` | 9655 | `d19e640f373a876f129060de52cd8a3fb3d2b001ff5aaa02014f80871be1fbe9` | Machine-readable case gallery with complete packet payloads. | `python -m portfolio_fee_drag_simulator case-gallery --output demo` |
