...
| `case_gallery.json` | `file://demo/case_gallery.json` | 9655 | `748b47c1fa394323f75fefb5f9e2da3c11ebf79ee535b78062c7e86d1f03b9ab` | Machine-readable case gallery with complete packet payloads. | `python -m portfolio_fee_drag_simulator case-gallery --output demo` |
