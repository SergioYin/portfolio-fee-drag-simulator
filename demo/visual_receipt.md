...
| `case_gallery.json` | `file://demo/case_gallery.json` | 9655 | `4fcce6b368aedf68f593bde6c4f58e46172939d1d56e1e6f480b995adbf7fc25` | Machine-readable case gallery with complete packet payloads. | `python -m portfolio_fee_drag_simulator case-gallery --output demo` |
