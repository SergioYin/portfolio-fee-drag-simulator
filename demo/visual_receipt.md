...
| `case_gallery.json` | `file://demo/case_gallery.json` | 9655 | `ff54fcf9b545a968fef50f73cdb19de1192433b68fab98466198bf08d49c97e1` | Machine-readable case gallery with complete packet payloads. | `python -m portfolio_fee_drag_simulator case-gallery --output demo` |
