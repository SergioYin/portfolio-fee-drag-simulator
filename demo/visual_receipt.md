...
| `case_gallery.json` | `file://demo/case_gallery.json` | 9655 | `4915d42ab7c83a1138b55523f6d04dd5a6729d5fa158f4e4cf7848349755acf6` | Machine-readable case gallery with complete packet payloads. | `python -m portfolio_fee_drag_simulator case-gallery --output demo` |
